    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-4 pt-24 pb-16", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-pink-400 mb-6", children: "AI" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8", children: aiToolsCategories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: `text-lg font-bold text-${category.color} mb-2`, children: category.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: category.tools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-slate-700 text-gray-200 px-3 py-1 rounded-full text-sm", children: tool }, tool)) })
          ] }, category.title)) })
        ] })
      ] }) }),
