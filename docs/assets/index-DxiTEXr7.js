  ...
  const projects = [
    {
      ...
      // Adjust location
      color: "teal",
      // Choose a new color like 'teal', 'orange', etc.
      skills: ["Python", "Image Processing", "CSV Handling", "Data Matching", "Automation"],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-gray-100 font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed w-full bg-slate-900/80 backdrop-blur-sm z-50 shadow-md", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-4 flex justify-between items-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex space-x-8", children: ["about", "experience", "hackathons", "projects", "skills", "education", "contact"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            className: `capitalize ${activeSection === item ? "text-blue-400 font-medium" : "text-gray-300 hover:text-white"}`,
            children: item
          },
          item
        )) }),
      ...
      mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-slate-800 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 flex flex-col space-y-4", children: ["about", "experience", "hackathons", "projects", "skills", "education", "contact"].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          onClick: () => scrollToSection(item),
          className: `capitalize text-left py-2 ${activeSection === item ? "text-blue-400 font-medium" : "text-gray-300 hover:text-white"}`,
          children: item
        },
        item
      )) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "container mx-auto px-4 pt-24 pb-16", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-4xl mx-auto text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-center gap-6 text-gray-300 mb-12", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "mailto:anirudhrajeev6055@gmail.com", className: "hover:text-white transition-colors", children: "anirudhrajeev6055@gmail.com" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 20, className: "text-pink-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+19497380305", className: "hover:text-white transition-colors", children: "+1 (949) 738-0305" })
            ] })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-purple-400 mb-4", children: "Certifications" }),
            ...
            ].map((cert) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Award, { size: 16, className: "text-yellow-400" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-300", children: cert })
            ] }, cert)) })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8", children: experiences.map((exp, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800/70 transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:items-start justify-between mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-xl font-bold text-white flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { size: 20, className: "text-blue-400" }),
                exp.title
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-400 text-lg", children: exp.company })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left md:text-right mt-2 md:mt-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400", children: exp.date }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 flex flex-wrap gap-2", children: exp.skills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "bg-slate-700/50 px-3 py-1 rounded-full text-sm flex items-center gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(skill.icon, { size: 14, className: "text-blue-400" }),
            skill.name
          ] }, i)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: exp.description.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-gray-300", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 18, className: "text-blue-400 mt-1 flex-shrink-0" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6", children: projects.map((project, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              ...
              project.subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-400 text-sm mb-2", children: project.subtitle }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col space-y-2 mb-4 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-blue-400", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 16, className: "mr-2" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.role })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center text-gray-400", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: project.date })
                ] })
              ] }),
              project.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 mb-4", children: project.description }),
              project.skills && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: project.skills.map((skill, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-slate-700/50 px-2 py-1 rounded-full text-xs text-gray-300", children: skill }, i)) }),
              project.publication && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-slate-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "publications", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-8 border-b border-blue-500 pb-2 inline-block", children: "Publications" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800/70 transition-all", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white mb-4", children: "A deep learning-powered wardrobe companion app for personalized fashion recommendations" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 mb-4", children: "Published research on an innovative outfit recommendation system using Neural Collaborative Filtering, achieving 65.32% accuracy in personalized fashion recommendations. The paper details the implementation of advanced deep learning techniques and the integration of the NeuMan Dataset for 3D user modeling." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400", children: "AIP Conference Proceedings" })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-8 border-b border-blue-500 pb-2 inline-block", children: "Tech Stack" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-blue-400 mb-4", children: "Languages & Tools" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: [
              ...
              "Data Analysis"
            ].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-slate-700 text-gray-200 px-3 py-1 rounded-full text-sm", children: skill }, skill)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-purple-400 mb-4", children: "Frameworks & Libraries" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: [
              "PyTorch",
              "LangChain",
              "HuggingFace",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-green-400 mb-4", children: "Visualization" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: ["Power BI", "Tableau", "Looker"].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-slate-700 text-gray-200 px-3 py-1 rounded-full text-sm", children: skill }, skill)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-yellow-400 mb-4", children: "Cloud & DevOps" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-3", children: ["Azure", "DevOps", "Zapier", "Make", "n8n", "Microsoft AutoGen", "LlamaIndex", "Pinecone", "Supabase"].map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-slate-700 text-gray-200 px-3 py-1 rounded-full text-sm", children: skill }, skill)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-pink-400 mb-6", children: "AI Tools & Platforms" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: aiToolsCategories.map((category) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800/50 rounded-lg p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: `text-lg font-bold mb-3 ${category.color === "blue-400" ? "text-blue-400" : category.color === "purple-400" ? "text-purple-400" : category.color === "green-400" ? "text-green-400" : category.color === "yellow-400" ? "text-yellow-400" : category.color === "pink-400" ? "text-pink-400" : "text-gray-300"}`, children: category.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: category.tools.map((tool) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-slate-700/70 text-gray-200 px-2 py-1 rounded-full text-xs", children: tool }, tool)) })
          ] }, category.title)) })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "education", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-8 border-b border-blue-500 pb-2 inline-block", children: "Education" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800/50 rounded-lg p-6 shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:justify-between md:items-start mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white", children: "MS in Business Analytics" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-400", children: "UC Irvine" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-1", children: "GPA: 3.5" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 mt-2 md:mt-0", children: "2023 – 2025" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Key Courses:" }),
              " NLP, Predictive/Prescriptive Analytics, Machine Learning, Marketing Analytics, Social Analytics, Technical Consulting"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800/50 rounded-lg p-6 shadow-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row md:justify-between md:items-start mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-bold text-white", children: "BS in Data Science" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-400", children: "Jain University" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 mt-1", children: "GPA: 3.6" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 mt-2 md:mt-0", children: "2020 – 2024" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-300", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Key Courses:" }),
              " Python, C++, SQL, NoSQL, Hadoop, Apache, Data Structures, Algorithms, HTML, CSS, Networks, Linux"
            ] })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold mb-8 border-b border-blue-500 pb-2 inline-block", children: "Contact Me" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 24, className: "text-blue-400" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-white", children: "Email" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300", children: "anirudhrajeev6055@gmail.com" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              className: "bg-slate-800 hover:bg-slate-700 rounded-lg p-6 flex items-center gap-4 transition-all",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 24, className: "text-purple-400" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-white", children: "Phone" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300", children: "+1 (949) 738-0305" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              ...
              className: "bg-slate-800 hover:bg-slate-700 rounded-lg p-6 flex items-center gap-4 transition-all",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { size: 24, className: "text-blue-400" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-white", children: "LinkedIn" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300", children: "linkedin.com/in/anirudh-rajeev" })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-800 rounded-lg p-6 flex items-center gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 24, className: "text-green-400" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-medium text-white", children: "Location" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300", children: "San Francisco Bay Area" })
            ] })
          ] })
        ] })
      ] }) })
